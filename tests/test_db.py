...
class TestDbFunctions(unittest.TestCase):
    ...
    def test_value_to_singer_value(self):
        ...
        self.assertEqual(db.selected_value_to_singer_value_impl('12:00:00-08:00', 'time with time zone'), '20:00:00')
        self.assertEqual(db.selected_value_to_singer_value_impl('24:00:00-08:00', 'time with time zone'), '08:00:00')
        ...
        self.assertEqual(db.selected_value_to_singer_value_impl('2020-05-01T12:00:00-08:00',
