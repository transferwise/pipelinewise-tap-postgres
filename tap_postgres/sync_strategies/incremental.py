    ...
    with metrics.record_counter(None) as counter:
        with post_db.open_connection(conn_info) as conn:
            ...
            with conn.cursor(cursor_factory=psycopg2.extras.DictCursor, name='pipelinewise') as cur:
                ...
                select_sql = _get_select_sql(escaped_columns, replication_key, replication_key_sql_datatype,
                                             replication_key_value, schema_name, stream)
...
def _get_select_sql(escaped_columns, replication_key, replication_key_sql_datatype, replication_key_value, schema_name,
                    stream):
